...
<div class="site-index">
    <div class="body-content">
        <?php if (Yii::$app->user->isGuest):?>
            <p style="font-weight:600">Необходимо авторизоваться, чтобы просматривать статьи друзей!</p>
        <?php else:?>
            ...
            <ul style="list-style-type:none">
                ...
                <?php foreach ($articles as $article):?>
                    <li>
                        ...
                        <?= Html::a('Просмотреть', ['view', 'id' => $article->id], ['class' => 'btn btn-primary'])?>
                    </li>
                <?php endforeach; ?>
                <?php else: ?>
                    <p style="font-weight:600">У <?= $user->username?> нет статей!</p>
                <?php endif; ?>
            </ul>
        <?php endif;?>
    </div>
